...
const TRANSACTION_TYPE_STYLES = {
  credit: { label: 'Credit (Earnings)', color: 'text-green-600', bg: 'bg-green-50', icon: ArrowUpCircle },
...
export const ProviderWallet = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8 font-sans">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">Earnings & Wallet</h1>
          <p className="text-sm text-gray-500 mt-1">Track your income and withdraw to your bank account.</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-3xl p-8 text-white shadow-lg relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8 -mr-6 -mt-6 rounded-full bg-white opacity-10"></div>
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2.5 bg-white/20 rounded-xl">
            <Wallet className="h-6 w-6" />
          </div>
          <span className="text-sm font-bold tracking-wider uppercase text-green-100">
            Available Balance
          </span>
        </div>
        ...
        <div className="mt-8">
          <button
            ...
            className="px-6 py-3 bg-white text-green-700 font-bold rounded-xl text-sm transition hover:bg-green-50 shadow-sm flex items-center gap-2"
          >
